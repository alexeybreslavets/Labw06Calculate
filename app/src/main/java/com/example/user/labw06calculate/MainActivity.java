...
public class MainActivity extends AppCompatActivity {
    Button plus, minus, umnogit, deleniye, dvoichnuy, mod, xor, rezVx, rezVy, ochistka;
    EditText X, Y, rez;
    double x, y, REZ;
    int a, b, REZ3;
    String REZ2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rezVy = (Button) findViewById(R.id.rezVy);
        ochistka = (Button) findViewById(R.id.ochistka);
        ...
        rezVy.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                try {
                    y = Double.parseDouble(rez.getText().toString());
        ...
        ochistka.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                X.setText("");
                Y.setText("");
                rez.setText("");
